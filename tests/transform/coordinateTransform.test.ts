import { transformDesktopClickToNormalized } from '../../apps/desktop/src/services/coordinateTransform.js';
...
function runTests() {
  ...
  const rect = { left: 100, top: 50, width: 400, height: 800 } as DOMRect;
